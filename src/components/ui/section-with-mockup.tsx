        ...
        <section className="relative py-24 md:py-48 bg-black overflow-hidden border-t border-white/5">
            <div className="container max-w-[1220px] w-full px-6 md:px-10 relative z-10 mx-auto">
                ...
                >
                    {/* Text Content */}
                    <motion.div
                        className={`flex flex-col items-start gap-8 mt-10 md:mt-0 max-w-[546px] mx-auto md:mx-0 ${textOrderClass}`}
                        variants={itemVariants}
                    >
                         <div className="space-y-4">
                            <h2 className="text-white text-4xl md:text-[56px] font-bold leading-tight tracking-tight font-display uppercase">
                                {title}
                            </h2>
                        </div>

                        <div className="text-zinc-400 text-base md:text-[18px] leading-relaxed font-light space-y-6">
                            {description}
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        {/* Main Mockup Card */}
                        <motion.div
                            className="relative w-full h-[405px] md:h-[637px] bg-white/5 rounded-[32px] backdrop-blur-[30px] border border-white/10 z-10 overflow-hidden shadow-2xl"
                            initial={{ y: reverseLayout ? 0 : 0 }}
                            whileInView={{ y: reverseLayout ? 20 : 30 }}
